...
const Quality = () => {
  ...
  return (
    <div className="relative bg-purple-700  pt-[100px] lg:pt-10 lg:pb-20 mt-36 pb-10  rounded-3xl flex flex-col items-center justify-center text-center gap-5 lg:justify-between md:flex-row md:mt-[18rem] px-5 mb-10 shadow-xl lg:mt-28 hover:shadow-[10px_10px_20px_#fa02024d,0_-10px_20px_#ff000080]">
